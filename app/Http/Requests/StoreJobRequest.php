...
class StoreJobRequest extends FormRequest
{
    ...
    {
        $rules = [
            'specialization_id' => 'required|exists:job_specializations,id',
            'city_id' => 'nullable|exists:cities,id',
            'title_ar' => 'required|string|max:255',
            'title_en' => 'required|string|max:255',
            'job_type' => 'nullable|in:full_time,part_time,remote,online',
            ...
            'apply_method' => 'required|in:in_app,whatsapp,email,external_link',
