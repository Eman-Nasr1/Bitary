...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('dashboard.courses.store') }}" method="POST" id="courseForm" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="category" id="category" class="form-control" required>
                                        ...
                                        <option value="vets" {{ old('category') == 'vets' ? 'selected' : '' }}>Vets</option>
                                        <option value="students" {{ old('category') == 'students' ? 'selected' : '' }}>Students</option>
                                        <option value="breeders" {{ old('category') == 'breeders' ? 'selected' : '' }}>Breeders</option>
                                    </select>
                                    @error('category')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="language" id="language" class="form-control" required>
                                        ...
                                        <option value="mixed" {{ old('language') == 'mixed' ? 'selected' : '' }}>Mixed</option>
                                    </select>
                                    @error('language')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="overview_en" id="overview_en" class="form-control" rows="3">{{ old('overview_en') }}</textarea>
                                    @error('overview_en')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="overview_ar" id="overview_ar" class="form-control" rows="3">{{ old('overview_ar') }}</textarea>
                                    @error('overview_ar')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <select name="instructors[]" id="instructors" class="form-control select2" multiple>
                                @foreach($instructors as $instructor)
                                    <option value="{{ $instructor->id }}" 
                                        {{ in_array($instructor->id, old('instructors', [])) ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="intro_video_url" id="intro_video_url" class="form-control" 
                                        value="{{ old('intro_video_url') }}" placeholder="https://www.youtube.com/watch?v=...">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="intro_video_iframe" id="intro_video_iframe" class="form-control" rows="2">{{ old('intro_video_iframe') }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="hours_per_week" id="hours_per_week" class="form-control" 
                                        value="{{ old('hours_per_week') }}" min="1">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="days_per_week" id="days_per_week" class="form-control" 
                                        value="{{ old('days_per_week') }}" min="1" max="7">
                                    @error('days_per_week')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" name="certificate_available" id="certificate_available" 
                                    class="custom-control-input" value="1" {{ old('certificate_available') ? 'checked' : '' }}>
                                <label class="custom-control-label" for="certificate_available">Certificate Available</label>
                            </div>
                        </div>
                        <div class="form-group" id="certificate_type_group" style="display: none;">
                            ...
                            <select name="certificate_type" id="certificate_type" class="form-control">
                                ...
                                <option value="digital" {{ old('certificate_type') == 'digital' ? 'selected' : '' }}>Digital</option>
                                <option value="physical" {{ old('certificate_type') == 'physical' ? 'selected' : '' }}>Physical</option>
                            </select>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" name="is_free" id="is_free" 
                                    class="custom-control-input" value="1" {{ old('is_free') ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="payment_method" id="payment_method" class="form-control" required>
                                ...
                                <option value="whatsapp" {{ old('payment_method') == 'whatsapp' ? 'selected' : '' }}>WhatsApp</option>
                            </select>
                            @error('payment_method')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group" id="whatsapp_link_group" style="display: none;">
                            ...
                            <input type="url" name="whatsapp_join_link" id="whatsapp_join_link" class="form-control" 
                                value="{{ old('whatsapp_join_link') }}" placeholder="https://chat.whatsapp.com/...">
