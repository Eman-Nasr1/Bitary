<!-- Edit Medicine Modal -->
<div class="modal fade" id="editMedicineModal{{ $medicine->id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="number" step="0.01" name="discount_percentage" class="form-control" value="{{ old('discount_percentage', $medicine->discount_percentage) }}">
            </div>
            <div class="form-group col-md-4">
          ...
          <div class="form-group">
            ...
            @if($medicine->image_url)
              <img src="{{ $medicine->image_url }}" width="80" class="img-thumbnail mt-2">
            @endif
          </div>
        </div>
