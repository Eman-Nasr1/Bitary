...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('dashboard.provider.jobs.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="alert alert-info">
                    <i class="fas fa-info-circle"></i> Your job will be submitted for review. It will be published after admin approval.
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="job_type" class="form-control @error('job_type') is-invalid @enderror">
                        ...
                        <option value="remote" {{ old('job_type') == 'remote' ? 'selected' : '' }}>Remote (عن بعد)</option>
                        <option value="online" {{ old('job_type') == 'online' ? 'selected' : '' }}>Online</option>
                    </select>
                    @error('job_type')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="responsibilities_ar" class="form-control @error('responsibilities_ar') is-invalid @enderror" rows="3">{{ old('responsibilities_ar') }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="responsibilities_en" class="form-control @error('responsibilities_en') is-invalid @enderror" rows="3">{{ old('responsibilities_en') }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="qualifications_ar" class="form-control @error('qualifications_ar') is-invalid @enderror" rows="3">{{ old('qualifications_ar') }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="qualifications_en" class="form-control @error('qualifications_en') is-invalid @enderror" rows="3">{{ old('qualifications_en') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <select name="apply_method" id="apply_method" class="form-control @error('apply_method') is-invalid @enderror" required>
                        <option value="in_app" {{ old('apply_method') == 'in_app' ? 'selected' : '' }}>In App</option>
                        <option value="whatsapp" {{ old('apply_method') == 'whatsapp' ? 'selected' : '' }}>WhatsApp</option>
                        <option value="email" {{ old('apply_method') == 'email' ? 'selected' : '' }}>Email</option>
                        <option value="external_link" {{ old('apply_method') == 'external_link' ? 'selected' : '' }}>External Link</option>
                    </select>
                    @error('apply_method')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
