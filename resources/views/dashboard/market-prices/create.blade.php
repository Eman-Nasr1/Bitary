...
@section('title', 'Create Market Price')

@section('content_header')
    <h1>Create Market Price</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-header">
            <h3>New Market Price</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('dashboard.market-prices.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="currency" id="currency" class="form-control" 
                                value="{{ old('currency', 'EGP') }}" required>
                            @error('currency')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    ...
                    <select name="trend" id="trend" class="form-control">
                        <option value="stable" {{ old('trend', 'stable') == 'stable' ? 'selected' : '' }}>Stable</option>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Create Market Price
                    </button>
