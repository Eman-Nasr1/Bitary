...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <a href="{{ route('dashboard.admin.job-applications.index') }}" class="btn btn-secondary">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Provider</th>
                            <td>{{ $application->job->provider->name ?? 'N/A' }}</td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-6">
            ...
            <h5>Update Status</h5>
            <form action="{{ route('dashboard.admin.job-applications.update-status', $application->id) }}" method="POST" class="mt-3">
                @csrf
                <div class="row">
                    <div class="col-md-4">
